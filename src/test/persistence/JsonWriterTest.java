...
import model.AllFantasyTeamsTest;
...
public class JsonWriterTest {
    ...
    @Test
    public void testWriterZeroFantasyTeams() {
        try {
            AllFantasyTeams allFantasyTeams = new AllFantasyTeams();
            JsonWriter writer = new JsonWriter("./data/ZeroFantasyTeams.json");
            writer.open();
            writer.write(allFantasyTeams);
            writer.close();

            JsonReader reader = new JsonReader("./data/ZeroFantasyTeams.json");
            allFantasyTeams = reader.read();
    ...
    @Test
    public void testWriterTwoFantasyTeams() {
        try {
            AllFantasyTeams allFantasyTeams = new AllFantasyTeams();
            ...
            JsonWriter writer = new JsonWriter("./data/testWriterTwoFantasyTeams.json");
            writer.open();
            writer.write(allFantasyTeams);
            writer.close();

            JsonReader reader = new JsonReader("./data/testWriterTwoFantasyTeams.json");
            allFantasyTeams = reader.read();
